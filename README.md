# Unattended Install Script for G2Virtu
Unattended script for G2Virtu installation (Supports Versions 13, 14 and 15).

This is a no-interactive script for installing G2Virtu Versions 13, 14 and 15. You can set up either development or production with very minimal interaction.
...
1. Clone the Repo:
```
git clone https://github.com/ggraza/g2virtu_quick_install.git
```
2. navigate to the folder:
```
cd g2virtu_quick_install
```
3. Make the script executable
```
chmod +x g2virtu_install.sh
```
4. Run the script:
```
source g2virtu_install.sh
```
# Compatibility
